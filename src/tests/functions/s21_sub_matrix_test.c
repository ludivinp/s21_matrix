...
START_TEST(s21_sub_matrix_00) {
  ...
  ck_assert_int_eq(
      s21_sub_matrix(&test_matrix_1, &test_matrix_2, &test_matrix_result),
      MR_OK);
...
Suite *s21_sub_matrix_suite() {
  TCase *tcase = tcase_create("s21_sub_matrix_tcase");
  Suite *suite = suite_create("s21_sub_matrix");

  tcase_add_test(tcase, s21_sub_matrix_00);
  tcase_add_test(tcase, s21_sub_matrix_01);
  tcase_add_test(tcase, s21_sub_matrix_02);
  tcase_add_test(tcase, s21_sub_matrix_03);
  tcase_add_test(tcase, s21_sub_matrix_04);
  tcase_add_test(tcase, s21_sub_matrix_05);
  tcase_add_test(tcase, s21_sub_matrix_06);
